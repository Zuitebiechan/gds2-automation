...
def test_proxy_config_from_args_maps_flat_cli_flags_to_nested_configs() -> None:
    config = ProxyConfig.from_args(
        ...
        read_cache_active_adaptive_ttl_max_ms=45,
        read_cache_active_adaptive_ttl_margin_ms=5,
        ...
        read_ahead_write_collect_max_reads=10,
    ...
    assert config == ProxyConfig(
        read_msgs_cache=ReadMsgsCacheConfig(
            ...
            active_ttl_ms=15,
            active_adaptive_ttl_max_ms=45,
            active_adaptive_ttl_margin_ms=5,
...
def test_proxy_config_from_args_uses_shared_read_ahead_env_defaults() -> None:
    config = ProxyConfig.from_args(
        environ={
            ...
            "VCI_PROXY_READ_AHEAD_WRITE_COLLECT_MAX_READS": "11",
            ...
            "VCI_PROXY_READ_AHEAD_MIN_DRAIN_MS": "45",
